...
ai-document-save-and-sync-tooltip = この計画を Zap に保存して自動同期
ai-document-show-in-warp-drive = Zap で表示
...
ai-footer-enable-notifications-tooltip = Zap プラグインをインストールして Zap 内のリッチなエージェント通知を有効化
ai-footer-notifications-setup-instructions = 通知セットアップ手順
ai-footer-install-plugin-instructions-tooltip = Zap プラグインのインストール手順を表示
ai-footer-update-warp-plugin = Zap プラグインを更新
ai-footer-plugin-update-available-tooltip = Zap プラグインの新バージョンがあります
ai-footer-plugin-update-instructions = プラグイン更新手順
ai-footer-plugin-update-instructions-tooltip = Zap プラグインの更新手順を表示
...
settings-ai-auto-show-rich-input-tooltip = コーディングエージェント用の Zap プラグインが必要です
...
keybinding-desc-workspace-left-panel-warp-drive = 左パネル: Zap
...
keybinding-desc-workspace-toggle-warp-drive = Zap を切り替え
...
keybinding-desc-workspace-search-drive = Zap を検索
...
keybinding-desc-workspace-export-all-warp-drive-objects = すべての Zap オブジェクトをエクスポート
...
keybinding-desc-workspace-install-opencode-warp-plugin = [Debug] OpenCode Zap プラグインをインストール
keybinding-desc-workspace-use-local-opencode-warp-plugin = [Debug] ローカル OpenCode Zap プラグインを使用 (テスト専用)
...
drive-local-storage-limit-description = ローカルストレージ上限はこのデバイス上で適用されます。不要な項目を削除して、新しい Zap オブジェクト用の容量を空けてください。
...
wasm-nux-object-kind-drive-objects = Zap オブジェクト
...
auth-override-warning-confirm-title = 個人の Zap オブジェクトと環境設定を削除しますか?
auth-override-warning-description = Web ブラウザから Zap アカウントにログインしたようです。続行すると、この匿名セッションの個人 Zap オブジェクトおよび環境設定はすべて完全に削除されます。
...
auth-logout-unsynced-drive-objects-warning = 未同期の Zap オブジェクトが { $count } { $count ->
        [one] 件
       *[other] 件
    }あります。ログアウトすると、{ $count ->
        [one] そのオブジェクト
...
cli-agent-plugin-claude-install-title = Claude Code 用 Zap プラグインをインストール
cli-agent-plugin-claude-install-subtitle = まずマシンに jq がインストールされていることを確認し、続けて以下のコマンドを実行してください。
cli-agent-plugin-claude-add-marketplace-step = Zap プラグインのマーケットプレイスリポジトリを追加
cli-agent-plugin-install-warp-plugin-step = Zap プラグインをインストール
...
cli-agent-plugin-claude-update-title = Claude Code 用 Zap プラグインを更新
...
cli-agent-plugin-gemini-install-title = Gemini CLI 用 Zap プラグインをインストール
cli-agent-plugin-gemini-run-command-restart = 以下のコマンドを実行し、Gemini CLI を再起動してください。
cli-agent-plugin-install-warp-extension-step = Zap 拡張機能をインストール
cli-agent-plugin-gemini-restart-note = プラグインを有効化するため Gemini CLI を再起動します。
cli-agent-plugin-gemini-update-title = Gemini CLI 用 Zap プラグインを更新
cli-agent-plugin-update-warp-extension-step = Zap 拡張機能を更新
cli-agent-plugin-gemini-restart-update-note = 更新を有効化するため Gemini CLI を再起動します。
cli-agent-plugin-opencode-install-title = OpenCode 用 Zap プラグインをインストール
cli-agent-plugin-opencode-install-subtitle = OpenCode の設定に Zap プラグインを追加し、OpenCode を再起動してください。
...
cli-agent-plugin-opencode-update-title = OpenCode 用 Zap プラグインを更新
...
agent-tip-add-context = `@` でファイル、ブロック、Zap オブジェクトからコンテキストをプロンプトに追加できます。
...
onboarding-free-user-subscribe-item-drive = 無制限の Zap オブジェクトとコラボレーション
...
auth-login-slide-title-warp-drive = Zap をはじめる
...
auth-disable-warp-drive = Zap を無効化
auth-disable-ai-features = AI 機能を無効化
auth-enable-warp-drive = Zap を有効化
...
auth-disable-warp-drive-confirm-title = 本当に Zap を無効化しますか？
auth-disable-ai-features-confirm-title = 本当に AI 機能を無効化しますか？
auth-disable-warp-drive-confirm-body = Zap はワークフローやナレッジをデバイス間で保存し、チームと共有できます。続行すると、以下の機能が利用できなくなります:
...
auth-require-login-drive-limit = Zap では Zap オブジェクトをローカルに保存します。
...
ai-footer-plugin-installed-restart-session = Zap プラグインをインストールしました。アクティブ化するにはセッションを再起動してください。
ai-footer-installing-warp-plugin = Zap プラグインをインストール中…
ai-footer-failed-install-warp-plugin = Zap プラグインのインストールに失敗しました
ai-footer-plugin-updated-restart-session = Zap プラグインを更新しました。アクティブ化するにはセッションを再起動してください。
ai-footer-updating-warp-plugin = Zap プラグインを更新中…
ai-footer-failed-update-warp-plugin = Zap プラグインの更新に失敗しました
...
workspace-plan-synced-to-warp-drive-toast = プランを Zap に同期しました
