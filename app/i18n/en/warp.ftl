...
ai-document-save-and-sync-tooltip = Save and auto-sync this plan to your Zap
ai-document-show-in-warp-drive = Show in Zap
...
ai-footer-enable-notifications-tooltip = Install the Zap plugin to enable rich agent notifications within Zap
ai-footer-notifications-setup-instructions = Notifications setup instructions
ai-footer-install-plugin-instructions-tooltip = View instructions to install the Zap plugin
ai-footer-update-warp-plugin = Update Zap plugin
ai-footer-plugin-update-available-tooltip = A new version of the Zap plugin is available
ai-footer-plugin-update-instructions = Plugin update instructions
ai-footer-plugin-update-instructions-tooltip = View instructions to update the Zap plugin
...
settings-section-warp-drive = Zap
...
settings-ai-auto-show-rich-input-tooltip = Requires the Zap plugin for your coding agent
...
# Manage Rules 页面(Zap 中的 AI Fact Collection)。
...
keybinding-desc-workspace-left-panel-warp-drive = Left Panel: Zap
...
keybinding-desc-workspace-toggle-warp-drive = Toggle Zap
keybinding-desc-workspace-toggle-warp-drive-menu = Zap
...
keybinding-desc-workspace-search-drive = Search Zap
...
keybinding-desc-workspace-export-all-warp-drive-objects = Export all Zap objects
...
keybinding-desc-workspace-install-opencode-warp-plugin = [Debug] Install OpenCode Zap plugin
keybinding-desc-workspace-use-local-opencode-warp-plugin = [Debug] Use local OpenCode Zap plugin (testing only)
...
search-filter-display-drive = Zap
...
drive-local-storage-limit-description = Local storage limits are enforced on this device. Remove unused items to create space for new Zap objects.
...
workspace-left-panel-warp-drive = Zap
...
wasm-nux-object-kind-drive-objects = Zap objects
...
auth-override-warning-confirm-title = Delete personal Zap objects and preferences?
auth-override-warning-description = It looks like you logged into a Zap account through a web browser. If you continue, any personal Zap objects and preferences from this anonymous session will be permanently deleted.
...
auth-logout-unsynced-drive-objects-warning = You have { $count } unsynced Zap { $count ->
        [one] object
       *[other] objects
...
cli-agent-plugin-claude-add-marketplace-step = Add the Zap plugin marketplace repository
cli-agent-plugin-install-warp-plugin-step = Install the Zap plugin
...
cli-agent-plugin-install-warp-extension-step = Install the Zap extension
...
cli-agent-plugin-update-warp-extension-step = Update the Zap extension
...
cli-agent-plugin-opencode-install-subtitle = Add the Zap plugin to your OpenCode configuration, then restart OpenCode.
...
agent-tip-add-context = `@` to add context from files, blocks, or Zap objects to your prompt.
...
agent-tip-action-warp-drive = Zap.
...
onboarding-customize-warp-drive = Zap
...
auth-login-slide-title-warp-drive = Get started with Zap
...
auth-disable-warp-drive = Disable Zap
auth-disable-ai-features = Disable AI features
auth-enable-warp-drive = Enable Zap
...
auth-disable-warp-drive-confirm-title = Are you sure you want to disable Zap?
auth-disable-ai-features-confirm-title = Are you sure you want to disable AI features?
auth-disable-warp-drive-confirm-body = Zap lets you save workflows and knowledge across devices and share them with your team. By continuing, you won't have access to the following features:
...
auth-require-login-drive-limit = Zap objects are stored locally in Zap.
...
ai-footer-plugin-installed-restart-session = Zap plugin installed. Please restart the session to activate.
ai-footer-installing-warp-plugin = Installing Zap plugin...
ai-footer-failed-install-warp-plugin = Failed to install Zap plugin
ai-footer-plugin-updated-restart-session = Zap plugin updated. Please restart the session to activate.
ai-footer-updating-warp-plugin = Updating Zap plugin...
ai-footer-failed-update-warp-plugin = Failed to update Zap plugin
...
workspace-plan-synced-to-warp-drive-toast = Plan synced to your Zap
